...
library(magick)      # to crop the image in a hexagonal shape
...
- I used the `cropcircles::hex_crop()` function to crop the image in a hexagonal shape, with a border of a specified color and size. I had to dug a bit to find the exact grey-blue colour of the GitHub website lines to use as the border colour for a cool "merging with the background" effect.
