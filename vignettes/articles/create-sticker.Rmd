...
- I used the `hex_crop()` function from `cropcircles`[^1] to crop the image in a hexagonal shape, 
with a border of a specified color and size. 
I had to dig a bit to find the exact grey-blue colour of the GitHub website lines to use as the border colour for a cool "merging with the background" effect.
...
[^1]: The `cropcircles` package was commented out in the setup chunk because it had a weird interference with the GitHub Actions used to deploy this website.
